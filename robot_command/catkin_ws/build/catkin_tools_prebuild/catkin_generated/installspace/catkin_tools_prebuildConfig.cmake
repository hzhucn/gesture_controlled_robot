...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/laure/HP Data/ROBOT_IMAGE_CONTROL/robot_command/catkin_ws/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/laure/HP Data/ROBOT_IMAGE_CONTROL/robot_command/catkin_ws/install/lib;/media/laure/HP Data/ROBOT_IMAGE_CONTROL/robot_command/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
